                    ...
                    barcodeText.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (barcodes.valueAt(0).email != null) {
                                ...
                                //kirim kembali data ke activity yang buka activity ini result
                                Intent intent = new Intent();
                                intent.putExtra("barcodedata", barcodeData);
                                setResult(RESULT_OK, intent); //set data sebagai result, berikan resultcode yaitu result_ok sebagai penanda
