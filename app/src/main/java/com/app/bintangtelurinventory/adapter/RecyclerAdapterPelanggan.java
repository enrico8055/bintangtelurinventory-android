...
import com.app.bintangtelurinventory.modeldata.Pelanggan;
...
public class RecyclerAdapterPelanggan extends RecyclerView.Adapter<RecyclerAdapterPelanggan.ViewHolder> {
    ...
    public RecyclerAdapterPelanggan() {
    }
    ...
    //getter data
    public Pelanggan getNotes(int position) {
        return Pelanggans.get(position); //kembalikan data note berdasarkan index yang dikitim
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView tv_notel;
        private TextView tv_idpelanggan;

        public ViewHolder(@NonNull View itemView) { //constructor
            super(itemView);

            //panggil item item di layout card_design_for_recycler_item.xml kita
            tv_namapelanggan = itemView.findViewById(R.id.tv_nama);
            tv_alamat = itemView.findViewById(R.id.tv_alamat);
            tv_notel = itemView.findViewById(R.id.tv_notel);
            tv_idpelanggan = itemView.findViewById(R.id.tv_idpelanggan);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (listener != null && getAdapterPosition() != RecyclerView.NO_POSITION) {
                        listener.onItemClick(Pelanggans.get(getAdapterPosition()));
                    }
                }
            });
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_design_for_recycler_item_pelanggan, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Pelanggan curr = Pelanggans.get(position);

        holder.tv_namapelanggan.setText(curr.getNama());
        holder.tv_alamat.setText(curr.getAlamat());
        holder.tv_notel.setText(curr.getNotelp());
        holder.tv_idpelanggan.setText(curr.getIdpelanggan());
    }
